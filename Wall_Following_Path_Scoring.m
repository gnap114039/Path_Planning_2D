function [start_node , dest_node , map , distanceFromStart , parent_node , flag ,route ] = Wall_Following_Path_Scoring(map,Algorithm_Selection,force_stop_flag,exploring_direction,target_point,startnode)
